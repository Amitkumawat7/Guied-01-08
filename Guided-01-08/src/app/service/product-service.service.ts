...
export class ProductServiceService {
  ...
  getAllCategories()  : Observable<ProductCategory[]>{
    console.log(this.httpclient.get<getCategoryResponse>(this.catURL).pipe(map(response => response._embedded.productcategories)))
    return this.httpclient.get<getCategoryResponse>(this.catURL).pipe(map(response => response._embedded.productcategories))
  }
